...
**v0.5.5 · Apple 芯片 Mac · 本机运行**

自动识别当前套牌，在对局中显示牌库变化、对手已出牌、竞技场选牌数据和关键计数。

[下载公开版](https://github.com/jackotom/lscs-mac-jpq/releases/latest) · [查看 v0.5.5 更新](docs/releases/v0.5.5.md)
...
- 修复记牌器已连接旧日志目录后，新的竞技场选牌记录无法自动接入的问题。
- 新会话选牌日志稍后出现或位于另一个目录时会自动切换，不需要重开记牌器。

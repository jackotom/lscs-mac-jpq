...
**v0.4.8 · Apple 芯片 Mac · 本机运行**

自动识别当前套牌，在对局中显示牌库变化、对手已出牌、竞技场选牌数据和关键计数。

[下载公开版](https://github.com/jackotom/lscs-mac-jpq/releases/latest) · [查看 v0.4.8 更新](docs/releases/v0.4.8.md)
...
- 包含 v0.4.7 引入的全局可拖动顶部任务栏，首页、设置和其它工作台页面共用同一条。
- 去掉首页顶栏中可见的“首页”文字，中央保持为完整、干净的窗口拖动区。
- 工作台继续显示“实时对局”等当前页面标题，右侧窗口按钮保持可点。

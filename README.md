...
**v0.6.6 · Apple 芯片 Mac · 本机运行**

自动识别当前套牌，在对局中显示牌库变化、对手已出牌、竞技场选牌数据和关键计数。

[下载公开版](https://github.com/jackotom/lscs-mac-jpq/releases/latest) · [查看 v0.6.6 更新](docs/releases/v0.6.6.md)
...
当前安装包使用 Developer ID 正式签名。v0.6.6 按本次发布选择未装订 Apple 公证票据；若系统提示“无法验证开发者”或“应用已损坏”，不要绕过安全检查，请重新从发布页下载并核对校验文件。

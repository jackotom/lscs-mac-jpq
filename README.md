...
**v0.5.1 · Apple 芯片 Mac · 本机运行**

自动识别当前套牌，在对局中显示牌库变化、对手已出牌、竞技场选牌数据和关键计数。

[下载公开版](https://github.com/jackotom/lscs-mac-jpq/releases/latest) · [查看 v0.5.1 更新](docs/releases/v0.5.1.md)
...
- 奥秘助手的问号和标题都能点击收起、展开，也能直接拖动调整位置。
- 收起后整个 `44×44` 入口都可点击和拖动，拖动不会误触展开。
- 奥秘位置、收起状态会在刷新和重启后保留，候选列表仍保持鼠标穿透。
- 我方与对手场攻圆钮可以分别拖动，刷新和重启后不会弹回旧位置。

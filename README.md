...
**v0.5.4 · Apple 芯片 Mac · 本机运行**

自动识别当前套牌，在对局中显示牌库变化、对手已出牌、竞技场选牌数据和关键计数。

[下载公开版](https://github.com/jackotom/lscs-mac-jpq/releases/latest) · [查看 v0.5.4 更新](docs/releases/v0.5.4.md)
...
- 只有旧的基础游戏日志时仍会继续自动查找；新的对局日志出现后自动连接，不需要重开记牌器。
- 保留现有悬浮计数器拖动、位置保存和屏幕避让能力。

...
**v0.5.6 · Apple 芯片 Mac · 本机运行**

自动识别当前套牌，在对局中显示牌库变化、对手已出牌、竞技场选牌数据和关键计数。

[下载公开版](https://github.com/jackotom/lscs-mac-jpq/releases/latest) · [查看 v0.5.6 更新](docs/releases/v0.5.6.md)
...
- 修复对手英雄职业与单个奥秘日志中的明确职业不一致时，奥秘助手无法显示正确候选的问题。
- 单个奥秘带有明确职业时，按该奥秘的职业生成候选；职业未知时仍使用对手英雄职业。
- 保留此前跨日志目录自动接入竞技场选牌记录的修复。

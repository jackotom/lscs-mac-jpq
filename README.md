...
**v0.5.3 · Apple 芯片 Mac · 本机运行**

自动识别当前套牌，在对局中显示牌库变化、对手已出牌、竞技场选牌数据和关键计数。

[下载公开版](https://github.com/jackotom/lscs-mac-jpq/releases/latest) · [查看 v0.5.3 更新](docs/releases/v0.5.3.md)
...
- 智能计数圆片、我方场攻和对手场攻都可以直接抓取拖动。
- 每个智能计数器独立保存位置；刷新、隐藏再显示、重启或显示器变化后不会串位、跳回。
- 轻微短按不会误移动；松手、取消或抓取丢失后立即恢复鼠标穿透，恢复失败会继续重试。
- 默认计数器不再压住场攻按钮，小屏、负坐标副屏和带 Dock 的工作区会自动换行避让。

...
**v0.4.6 · Apple 芯片 Mac · 本机运行**

自动识别当前套牌，在对局中显示牌库变化、对手已出牌、竞技场选牌数据和关键计数。

[下载最新版](https://github.com/jackotom/lscs-mac-jpq/releases/latest) · [查看 v0.4.6 更新](https://github.com/jackotom/lscs-mac-jpq/releases/tag/v0.4.6)
...
- 地下竞技场开始前立即显示 31–35 张候选牌，并标明“候选 · 最终30”。
- 收到准确的 30 张牌表后自动替换候选状态，不沿用旧套牌。
- 对局结束后保留当前牌表，同时清空上一局的区域、历史和计数。
- 奥秘助手改为紧凑单列卡图布局，并按候选数量调整窗口高度。
